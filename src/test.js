...
//     if (amount == 0 || amount == "") {
//       Alert.alert("Please select or enter a valid amount");
//       return;
//     }
//     if (amount < 10) {
//       Alert.alert("Minimum purchase limit is 10 rupees");
//       return;
//     }
//     if (amount > 1000) {
//       Alert.alert("Maximum purchase limit is 1000 rupees");
//       return;
//     }
...
//     api
//       .generatePaymentRequest(uid, api_key, amount, type)
//       .then(response => {
...
//     api
//       .verifyPaymentRequest(uid, api_key, order_id)
//       .then(response => {
//         if (response.responseCode == 401) {
//           Alert.alert("Unauthorized REST API request");
//         } else {
...
//               "We have added money to your account, enjoy your game"
//             );
//           } else {
...
//         Alert.alert(
//           "Error",
//           "Unable to complete transaction, please check your bills. In case of any query you can contact us"
//         );
//       });
//   }
//   render() {
...
//         <View style={{ flex: 1 }}>
//           <TextInput
//             ref={component => (this._amountTxtBox = component)}
//             style={{
//               height: 50,
  ...
  render() {
    return (
      <WebView
        source={{
          uri:
            "http://www.siridigitalmarketing.com/checkout/order-pay/1687/?pay_for_order=true&key=wc_order_DX5NKkOqi59Ly"
        }}
      />
    );
  }
